    ...
    public partial class DBConnection
    {
        static public string GetConnectionString()
        {
            try
            {
                ...
                string base64Str = connectionString["MysqlDb"].ConnectionString;
                var base64EncodeBytes = System.Convert.FromBase64String(base64Str);
                string host = appSettings["host"] ?? "Not Found";

                string result = "Server=" + host + ";" + System.Text.Encoding.UTF8.GetString(base64EncodeBytes);
                return result;
            }
        ...
        static public DataTable GetDataByQuery(string query)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("Không kết nối được đến Server. Kiểm tra lại kết nối internet");
                return null;
            }
             try
            {
